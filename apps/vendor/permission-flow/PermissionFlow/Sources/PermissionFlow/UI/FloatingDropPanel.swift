...
final class FloatingDropPanel: NSPanel {
    ...
    init(controller: PermissionFlowController) {
        TalosPermissionFlowDebugLog.write("FloatingDropPanel_init_entered")
        panelController = controller
        localeIdentifier = controller.localeIdentifier
        TalosPermissionFlowDebugLog.write("FloatingDropPanel_init_before_makePanelView")
        let panelView = Self.makePanelView(controller: controller, localeIdentifier: controller.localeIdentifier)
        TalosPermissionFlowDebugLog.write("FloatingDropPanel_init_after_makePanelView")
        TalosPermissionFlowDebugLog.write("FloatingDropPanel_init_before_NSHostingView")
        hostingView = NSHostingView(rootView: panelView)
        sizingView = NSHostingView(rootView: panelView)
        TalosPermissionFlowDebugLog.write("FloatingDropPanel_init_after_NSHostingView")
        TalosPermissionFlowDebugLog.write("FloatingDropPanel_init_before_super")
        super.init(
        ...
        TalosPermissionFlowDebugLog.write("FloatingDropPanel_init_after_super")
        ...
        TalosPermissionFlowDebugLog.write("FloatingDropPanel_init_before_setContentSize")
        setContentSize(CGSize(width: initialPanelWidth, height: measuredPanelHeight(for: initialPanelWidth)))
        TalosPermissionFlowDebugLog.write("FloatingDropPanel_init_completed frame=\(TalosPermissionFlowDebugLog.describe(frame))")
    }
    ...
    override func setContentSize(_ size: NSSize) {
        TalosPermissionFlowDebugLog.write("FloatingDropPanel_setContentSize_entered width=\(size.width) height=\(size.height)")
        let width = max(1, size.width)
        super.setContentSize(NSSize(width: width, height: measuredPanelHeight(for: width)))
        TalosPermissionFlowDebugLog.write("FloatingDropPanel_setContentSize_completed frame=\(TalosPermissionFlowDebugLog.describe(frame))")
    }

    /// Shows the panel at its current frame without any positioning changes.
    func show() {
        TalosPermissionFlowDebugLog.write("FloatingDropPanel_show")
    ...
    func show(at sourceFrameInScreen: CGRect) {
        TalosPermissionFlowDebugLog.write("FloatingDropPanel_show_at_entered sourceFrame=\(TalosPermissionFlowDebugLog.describe(sourceFrameInScreen))")
        stopLaunchAnimation()
        isAnimatingLaunch = false
        alphaValue = 1
        setContentSize(CGSize(width: frame.width, height: measuredPanelHeight(for: frame.width)))
        setFrame(launchSourceFrame(for: sourceFrameInScreen), display: false)
        TalosPermissionFlowDebugLog.write("FloatingDropPanel_show_at_before_orderFront frame=\(TalosPermissionFlowDebugLog.describe(frame))")
        orderFrontRegardless()
        TalosPermissionFlowDebugLog.write("FloatingDropPanel_show_at_completed")
    }
    ...
    func present(from sourceFrameInScreen: CGRect, to settingsFrame: CGRect) {
        TalosPermissionFlowDebugLog.write(
            "FloatingDropPanel_present_entered sourceFrame=\(TalosPermissionFlowDebugLog.describe(sourceFrameInScreen)) settingsFrame=\(TalosPermissionFlowDebugLog.describe(settingsFrame))"
        )
        stopLaunchAnimation()
        let targetFrame = targetFrame(for: settingsFrame)
        TalosPermissionFlowDebugLog.write("FloatingDropPanel_present_targetFrame targetFrame=\(TalosPermissionFlowDebugLog.describe(targetFrame))")

        guard sourceFrameInScreen.isEmpty == false else {
            isAnimatingLaunch = false
            alphaValue = 1
            setFrame(targetFrame, display: false)
            TalosPermissionFlowDebugLog.write("FloatingDropPanel_present_empty_source_before_orderFront")
            orderFrontRegardless()
            TalosPermissionFlowDebugLog.write("FloatingDropPanel_present_empty_source_completed")
            return
        }
        ...
        TalosPermissionFlowDebugLog.write("FloatingDropPanel_present_before_orderFront launchFromFrame=\(TalosPermissionFlowDebugLog.describe(launchFromFrame)) launchToFrame=\(TalosPermissionFlowDebugLog.describe(launchToFrame))")
        orderFrontRegardless()
        TalosPermissionFlowDebugLog.write("FloatingDropPanel_present_after_orderFront")
        stepLaunchAnimation()
        TalosPermissionFlowDebugLog.write("FloatingDropPanel_present_after_first_stepLaunchAnimation")
        ...
        launchTimer = timer
        TalosPermissionFlowDebugLog.write("FloatingDropPanel_present_completed")
    }
    ...
    func snap(to settingsFrame: CGRect) {
        TalosPermissionFlowDebugLog.write("FloatingDropPanel_snap_entered settingsFrame=\(TalosPermissionFlowDebugLog.describe(settingsFrame))")
        ...
        if isAnimatingLaunch {
            ...
            TalosPermissionFlowDebugLog.write("FloatingDropPanel_snap_updated_launchToFrame target=\(TalosPermissionFlowDebugLog.describe(target))")
            return
        }

        stopLaunchAnimation()
        setFrame(target, display: false)
        TalosPermissionFlowDebugLog.write("FloatingDropPanel_snap_before_orderFront target=\(TalosPermissionFlowDebugLog.describe(target))")
        orderFrontRegardless()
        TalosPermissionFlowDebugLog.write("FloatingDropPanel_snap_completed")
    }
    ...
    private static func makePanelView(
        ...
        TalosPermissionFlowDebugLog.write("FloatingDropPanel_makePanelView_entered locale=\(localeIdentifier ?? "nil")")
        let view = PermissionFlowPanelView(controller: controller)
        guard let localeIdentifier else {
            TalosPermissionFlowDebugLog.write("FloatingDropPanel_makePanelView_completed_without_locale")
            return AnyView(view)
        }
        let result = AnyView(view.environment(\.locale, .init(identifier: localeIdentifier)))
        TalosPermissionFlowDebugLog.write("FloatingDropPanel_makePanelView_completed_with_locale")
        return result
    }
}
#endif
