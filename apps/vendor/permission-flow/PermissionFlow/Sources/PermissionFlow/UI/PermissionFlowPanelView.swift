...
struct PermissionFlowPanelView: View {
    ...
    var body: some View {
        let _ = TalosPermissionFlowDebugLog.write(
            "PermissionFlowPanelView_body_entered hasPreferredApp=\(controller.preferredAppURL != nil) currentPane=\(String(describing: controller.currentPane))"
        )
    ...
    private var headerTitle: AttributedString {
        TalosPermissionFlowDebugLog.write("PermissionFlowPanelView_headerTitle_entered")
        ...
        TalosPermissionFlowDebugLog.write("PermissionFlowPanelView_headerTitle_markdown markdown=\(markdown)")
    ...
    private var appDisplayName: String {
        TalosPermissionFlowDebugLog.write("PermissionFlowPanelView_appDisplayName_entered")
        ...
        TalosPermissionFlowDebugLog.write("PermissionFlowPanelView_appDisplayName_resolved path=\(appURL.path) displayName=\(displayName)")
        return displayName
    }
    ...
    private var paneDisplayTitle: String {
        TalosPermissionFlowDebugLog.write("PermissionFlowPanelView_paneDisplayTitle_entered pane=\(String(describing: controller.currentPane))")
        let title = controller.currentPane?.localizedTitle(localeIdentifier: controller.localeIdentifier)
            ?? PermissionFlowLocalizer.string(
                "permission_flow.pane.permission",
                defaultValue: "Permission",
                localeIdentifier: controller.localeIdentifier
            )
        TalosPermissionFlowDebugLog.write("PermissionFlowPanelView_paneDisplayTitle_resolved title=\(title)")
        return title
    }
